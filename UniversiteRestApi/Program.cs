...
{
    var context = serviceProvider.GetRequiredService<UniversiteDbContext>();
    var roleManager = serviceProvider.GetService<RoleManager<UniversiteRole>>();
    var userManager = serviceProvider.GetService<UserManager<UniversiteUser>>();
    return new RepositoryFactory(context, roleManager, userManager);
});
